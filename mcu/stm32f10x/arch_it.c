...
#if IRQ_ENABLE
int arch_ExtIrqRegister(int nPort, int nPin, int nTriggerMode)
{
...
void arch_ExtIrqEnable(int nPort, int nPin, int nMode)
{ 
	EXTI_InitTypeDef xEXTI;
...
void arch_ExtIrqDisable(int nPort, int nPin)
{
	EXTI_InitTypeDef xEXTI;
...
* Return         : None
*******************************************************************************/
WEAK void HardFaultException(void)
{
...
* Return         : None
*******************************************************************************/
WEAK void MemManageException(void)
{
...
* Return         : None
*******************************************************************************/
WEAK void BusFaultException(void)
{
...
* Return         : None
*******************************************************************************/
WEAK void UsageFaultException(void)
{
